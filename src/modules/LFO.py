...
class LFOModule(ModuleBase):
    def __init__(self, pos):
        ...
        self.potentiometers.append(Potentiometer((self.size[0] / 2, 100), self, 0.1, min_value=0.1, max_value=10))
        self.potentiometers.append(Potentiometer((self.size[0] / 2, 200), self, 1, min_value=0, max_value=7.9))
